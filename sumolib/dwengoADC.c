...
void initADC() {
  ...
  */
  OpenADC(ADC_FOSC_64 & ADC_RIGHT_JUST & ADC_6_TAD, ADC_CH0 & ADC_INT_OFF & ADC_VREFPLUS_VDD & ADC_VREFMINUS_VSS, 0b1001);   // Configuring ADC
}
...
int readADC(BYTE address) {
  ...
  switch(address) {
    ...
    case 5: SetChanADC(ADC_CH5); break;
